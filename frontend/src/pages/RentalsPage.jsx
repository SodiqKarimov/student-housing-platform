...
const s = {
  ...
  tableHead: { display: 'grid', gridTemplateColumns: '2fr 1.2fr 1.5fr 1.5fr 1fr 1fr 1.2fr 0.9fr', padding: '12px 16px', background: '#f8f9fa', fontWeight: 600, fontSize: 13, color: '#555', borderBottom: '1px solid #eee' },
  tableRow: { display: 'grid', gridTemplateColumns: '2fr 1.2fr 1.5fr 1.5fr 1fr 1fr 1.2fr 0.9fr', padding: '12px 16px', borderBottom: '1px solid #f5f5f5', fontSize: 14, alignItems: 'center' },
